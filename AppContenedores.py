...
def leerDatos(localidad):
  datos = pd.read_csv('Data/ListadoCompleto.csv', delimiter=sep, header=header, names=nom_col)
...
"""Método igual que el anterior, pero que se usará en caso de quer añadir la restricción de las Time Windows, aunque no llega a usarse. Simplemente, es otra opción"""
